...
main.add(('Logged', [('Shopping', Operations.shopping), ('Asset', Operations.assets), ('Add Book', Operations.add_book),('Information', Operations.information), ('Edit Account', Operations.edit),  ('Logout', Operations.logout)]))
